	    ...
	    while (timer <= number_of_time_periods)
 	    {
		    ...
		    /* divide by number of players
		        check if entrant == 1, then add
		    
		    fprintf(stream2, "\n Number of entrants = %d", players);
            fprintf(stream2, "\n price_per_time = %f", price_per_time);
		    fprintf(stream2, "\n Price = %f", (price_per_time/players));
		    fprintf(stream2, "\n Total output = %f", (total_output));
		    fprintf(stream2, "\n Average output = %f", (total_output/players));
            fprintf(stream2, "\n Minimum output = %f", min_output);
            fprintf(stream2, "\n Maximum output = %f", max_output);
            fprintf(stream2, "\n Average mcost = %f", (avg_mcost/players));
            fprintf(stream2, "\n Minimum output = %f", min_mcost);
            fprintf(stream2, "\n Maximum output = %f", max_mcost);
            fprintf(stream2, "\n Average profit = %f", (avg_profit/players));
            fprintf(stream2, "\n Minimum profit = %f", min_profit);
            fprintf(stream2, "\n Maximum profit = %f", max_profit);
            fprintf(stream2, "\n Average rule = %f", avg_rule);
            fprintf(stream2, "\n == \n");*/
